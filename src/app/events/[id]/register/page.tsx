...
export default function RegisterForEventPage() {
  ...
  const getPrefilledValue = (field: CustomField, currentUser: User, currentProfile: ProfileInfo | null) => {
    ...
    try {
      ...
      if (profileResponse.ok) {
        ...
        const mergedProfile: ProfileInfo = {
          ...
          collegeId: profileObj.collegeId || profileData.collegeId || currentUser.collegeId,
